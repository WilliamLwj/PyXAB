# -*- coding: utf-8 -*-
"""Implementation of Random K-ary Partition
"""
...
class RandomKaryPartition(Partition):
    """
    ...
    def make_children(self, parent, newlayer=False):
        """
        The function to make children for the parent node with a random K-ary partition, i.e., split every
        parent node into K children nodes of different sizes. If there are multiple dimensions, the dimension to split
        the parent is chosen randomly
        ...
        new_nodes = []
        boundary_point_0 = selected_dim[0]
